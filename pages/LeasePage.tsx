...
import { LeaseChecklist } from '../components/lease/LeaseChecklist';
    ...
    <div className="flex-1 bg-gray-100 dark:bg-gray-900">
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
            {/* Main Form Content */}
            <div className="flex-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 w-full">
             ...
             {/* Checklist Sidebar */}
             <LeaseChecklist currentStep={currentStep} />
        </div>
      </div>
    </div>
  );

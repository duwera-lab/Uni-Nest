...
export const GlobeAmericasIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM8.543 4.685A.75.75 0 019 4.5h6a.75.75 0 01.457.185 8.251 8.251 0 00-6.914 0zM15.457 19.315a.75.75 0 01-.457.185h-6a.75.75 0 01-.457-.185 8.251 8.251 0 006.914 0zM18.5 13.5a.75.75 0 01.75-.75h.75a.75.75 0 010 1.5h-.75a.75.75 0 01-.75-.75zM4.75 12.75a.75.75 0 01.75.75h.75a.75.75 0 010-1.5h-.75a.75.75 0 01-.75.75z" />
        <path fillRule="evenodd" d="M12 17.25a.75.75 0 01-.75-.75A4.5 4.5 0 0115.75 12a.75.75 0 010-1.5 6 6 0 00-7.5 0 .75.75 0 010 1.5A4.5 4.5 0 0112.75 16.5a.75.75 0 01-.75.75z" clipRule="evenodd" />
    </svg>
);

export const WhatsAppIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M12.01,2.02c-5.52,0-9.99,4.47-9.99,9.99c0,1.77,0.46,3.45,1.29,4.91L2.02,22l5.24-1.37 c1.41,0.78,2.99,1.2,4.68,1.2h0.01c5.52,0,9.99-4.47,9.99-9.99S17.53,2.02,12.01,2.02z M16.63,14.88 c-0.27-0.14-1.59-0.78-1.84-0.87c-0.25-0.09-0.44-0.14-0.62,0.14c-0.18,0.27-0.69,0.87-0.85,1.04c-0.16,0.18-0.31,0.19-0.58,0.07 c-0.27-0.13-1.14-0.42-2.17-1.33c-0.8-0.72-1.34-1.61-1.5-1.88c-0.16-0.27-0.02-0.42,0.12-0.56c0.12-0.12,0.27-0.31,0.41-0.47 c0.14-0.16,0.18-0.27,0.27-0.46c0.09-0.18,0.05-0.35-0.02-0.49c-0.07-0.14-0.62-1.49-0.85-2.03c-0.23-0.54-0.46-0.47-0.62-0.47 c-0.15,0-0.33-0.02-0.5-0.02s-0.44,0.07-0.68,0.34c-0.24,0.27-0.92,0.9-0.92,2.19s0.94,2.54,1.07,2.71 c0.13,0.18,1.85,2.83,4.48,3.95c0.62,0.26,1.1,0.42,1.47,0.53c0.5,0.16,0.95,0.13,1.3-0.07c0.39-0.22,1.59-1.04,1.81-1.3 c0.22-0.26,0.22-0.49,0.16-0.62C17.06,15.02,16.89,14.95,16.63,14.88z" />
    </svg>
);

export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M5.337 21.063a1.5 1.5 0 01-1.95-2.036l1.33-2.662a.75.75 0 00-.516-1.083H3.75a3 3 0 01-3-3V6.75a3 3 0 013-3h12a3 3 0 013 3v6a3 3 0 01-3 3h-2.036a.75.75 0 00-.516 1.083l1.33 2.662a1.5 1.5 0 01-1.95 2.036L12 18.25l-2.663 2.813zM15.75 12h.75a1.5 1.5 0 001.5-1.5V6.75a1.5 1.5 0 00-1.5-1.5h-12a1.5 1.5 0 00-1.5 1.5v4.5a1.5 1.5 0 001.5 1.5h.75a.75.75 0 010 1.5H3.75a3 3 0 01-3-3V6.75a3 3 0 013-3h12a3 3 0 013 3v4.5a3 3 0 01-3 3h-.75a.75.75 0 010-1.5z" clipRule="evenodd" />
    </svg>
);
...
export const ShieldCheckIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M12 1.5c-5.025 0-9.215 3.541-9.75 8.064l.065.529c.422 3.425 2.585 6.36 5.53 7.915a.75.75 0 00.81 0c2.944-1.555 5.108-4.49 5.53-7.915l.065-.529C21.215 5.041 17.025 1.5 12 1.5zm-3.02 9.53a.75.75 0 011.06 0l1.5 1.5l3.22-3.22a.75.75 0 111.06 1.06l-3.75 3.75a.75.75 0 01-1.06 0l-2-2a.75.75 0 010-1.06z" clipRule="evenodd" />
  </svg>
);

export const SunIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 2.25a.75.75 0 01.75.75v2.25a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75zM7.5 12a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM18.894 6.106a.75.75 0 010 1.06l-1.591 1.59a.75.75 0 11-1.06-1.06l1.59-1.59a.75.75 0 011.06 0zM21.75 12a.75.75 0 01-.75.75h-2.25a.75.75 0 010-1.5H21a.75.75 0 01.75.75zM17.803 17.803a.75.75 0 01-1.06 0l-1.59-1.591a.75.75 0 111.06-1.06l1.59 1.59a.75.75_0 010 1.06zM12 21a.75.75 0 01-.75-.75v-2.25a.75.75 0 011.5 0V21a.75.75 0 01-.75-.75zM4.197 17.803a.75.75 0 010-1.06l1.59-1.591a.75.75 0 111.06 1.06l-1.59 1.59a.75.75 0 01-1.06 0zM3 12a.75.75 0 01.75-.75h2.25a.75.75 0 010 1.5H3.75A.75.75 0 013 12zM6.106 6.106a.75.75 0 011.06 0l1.591 1.59a.75.75 0 11-1.06 1.06l-1.59-1.59a.75.75 0 010-1.06z" />
    </svg>
);
...
export const CalendarDaysIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M6.75 2.25A.75.75 0 017.5 3v1.5h9V3A.75.75 0 0118 3v1.5h.75a3 3 0 013 3v11.25a3 3 0 01-3 3H5.25a3 3 0 01-3-3V7.5a3 3 0 013-3H6V3a.75.75 0 01.75-.75zM5.25 6.75c-.414 0-.75.336-.75.75v11.25c0 .414.336.75.75.75h13.5c.414 0 .75-.336.75-.75V7.5c0-.414-.336-.75-.75-.75H5.25z" clipRule="evenodd" />
        <path d="M10.5 10.5a.75.75 0 00-1.5 0v.75a.75.75 0 001.5 0v-.75zM10.5 13.5a.75.75 0 00-1.5 0v.75a.75.75 0 001.5 0v-.75zM13.5 10.5a.75.75 0 00-1.5 0v.75a.75.75 0 001.5 0v-.75zM13.5 13.5a.75.75 0 00-1.5 0v.75a.75.75 0 001.5 0v-.75zM16.5 10.5a.75.75 0 00-1.5 0v.75a.75.75 0 001.5 0v-.75zM16.5 13.5a.75.75 0 00-1.5 0v.75a.75.75 0 001.5 0v-.75z" />
    </svg>
);